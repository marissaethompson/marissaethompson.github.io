...
The first strand of my research focuses on inequality and segregation in educational contexts. Inequality in both opportunity and outcomes are a stubbornly persistent feature of the American educational system. My work seeks to shed light on the extent of this inequality, how it develops, and the mechanisms that explain its endurance. For example, some of my [recently published work](https://journals.sagepub.com/doi/10.3102/00028312221134769){:target="_blank"} examines how educational inequality has shifted in the post-recession, pre-pandemic period, mapping both how achievement disparities have changed over time and the extent to which they are predicted by changing segregation levels. In addition, ongoing work on these topics examines the sources of the Black gender gap in educational attainment, the causal effects of school district secessions on achievement gaps, and the causal effect of a first-dollar scholarship policy on college access, among others.
